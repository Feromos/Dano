...
df_1 = pd.read_excel('Tables/зарплата.xlsx', index_col='time')
df_2 = pd.read_excel('Tables/корзины.xlsx', index_col='time')
d = {'time': df_1.index}
...
df_3 = pd.DataFrame(d)
df_3.to_excel('Tables/корзины за зарплату.xlsx', index=False)
# df_1.plot()
# plt.show()
